 ...
 * Description: Provides operational metadata endpoints exposing resolved configuration for health and diagnostics.
 */
package com.bobwares.customer.registration.web;
...
public class MetaController {
  ...
  public Map<String, Object> env() {
    return Map.of(
        ...
        "defaultTaxRate", properties.getDefaultTaxRate(),
        "defaultShippingCost", properties.getDefaultShippingCost(),
