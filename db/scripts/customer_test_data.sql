...
-- Description: Inserts sample customer data for testing.
...
INSERT INTO postal_address (address_id, line1, line2, city, state, postal_code, country) VALUES
    ...
    (11, '1100 Spruce St', NULL, 'Columbus', 'OH', '43004', 'US'),
    (12, '1200 Poplar Ave', NULL, 'Nashville', 'TN', '37201', 'US'),
    (13, '1300 Hickory Rd', NULL, 'Raleigh', 'NC', '27513', 'US'),
    (14, '1400 Cypress Ln', NULL, 'Charlotte', 'NC', '28202', 'US'),
    (15, '1500 Redwood Dr', NULL, 'San Jose', 'CA', '95112', 'US'),
    (16, '1600 Palm St', NULL, 'Orlando', 'FL', '32801', 'US'),
    (17, '1700 Fir Ct', NULL, 'Dallas', 'TX', '75201', 'US'),
    (18, '1800 Cottonwood Pl', NULL, 'Houston', 'TX', '77002', 'US'),
    (19, '1900 Magnolia Blvd', NULL, 'Birmingham', 'AL', '35203', 'US'),
    (20, '2000 Willow Way', NULL, 'Sacramento', 'CA', '94203', 'US')
...
INSERT INTO privacy_settings (privacy_settings_id, marketing_emails_enabled, two_factor_enabled) VALUES
    ...
    (11, TRUE, FALSE), (12, FALSE, TRUE), (13, TRUE, TRUE), (14, FALSE, FALSE), (15, TRUE, FALSE),
    (16, FALSE, TRUE), (17, TRUE, TRUE), (18, FALSE, FALSE), (19, TRUE, FALSE), (20, FALSE, TRUE)
ON CONFLICT DO NOTHING;
...
INSERT INTO customer (customer_id, first_name, middle_name, last_name, address_id, privacy_settings_id) VALUES
    ...
    ('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'Noah', NULL, 'Thompson', 14, 14),
    ('ffffffff-ffff-ffff-ffff-ffffffffffff', 'Olivia', NULL, 'Garcia', 15, 15),
    ('11111111-2222-3333-4444-555555555555', 'Peter', NULL, 'Martinez', 16, 16),
    ('22222222-3333-4444-5555-666666666666', 'Quinn', NULL, 'Robinson', 17, 17),
    ('33333333-4444-5555-6666-777777777777', 'Rachel', NULL, 'Clark', 18, 18),
    ('44444444-5555-6666-7777-888888888888', 'Samuel', NULL, 'Rodriguez', 19, 19),
    ('55555555-6666-7777-8888-999999999999', 'Tina', NULL, 'Lewis', 20, 20)
ON CONFLICT DO NOTHING;
...
INSERT INTO customer_email (customer_id, email) VALUES
    ...
    ('11111111-2222-3333-4444-555555555555', 'peter@example.com'),
    ('22222222-3333-4444-5555-666666666666', 'quinn@example.com'),
    ('33333333-4444-5555-6666-777777777777', 'rachel@example.com'),
    ('44444444-5555-6666-7777-888888888888', 'samuel@example.com'),
