...
-- Exports: customer, postal_address, privacy_settings, customer_email, customer_phone_number, customer_overview
-- Description: Creates normalized customer domain tables and supporting indexes for PostgreSQL 16.
